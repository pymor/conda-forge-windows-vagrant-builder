...
# Finally, Visual Studio build tools. Note that with the "right" parameters
# this install can easily take an extremely long time and oodles of disk
# space.

choco install visualstudio2017buildtools --package-parameters "--passive --locale en-US --add Microsoft.VisualStudio.Workload.VCTools"
